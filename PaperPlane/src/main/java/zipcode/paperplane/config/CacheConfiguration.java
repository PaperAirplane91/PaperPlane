package zipcode.paperplane.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, zipcode.paperplane.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, zipcode.paperplane.repository.UserRepository.USERS_BY_EMAIL_CACHE);

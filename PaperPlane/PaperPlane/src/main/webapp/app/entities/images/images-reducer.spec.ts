...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './images.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IMAGES_LIST actions', async () => {
    ...
    it('dispatches FETCH_IMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IMAGES actions', async () => {
      const expectedActions = [
        {
